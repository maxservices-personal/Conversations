...
const Navbar = () => {
  return (
    <div className='sticky top-0 w-full h-fit py-3 px-5 border-b border-token-border-medium '>
        <div className="flex items-center h-fit gap-2 text-[#0b0b0b]">
            <span>
                <svg
            ...
            <div className="bg-black h-[30px] rounded-3xl w-[1px]  "></div>
            <div className='text-[16px] text-[#2e2e2e]'>MAX Services</div>
        </div>
    </div>
  )
}
