...
const App = () => {
  ...
  const { authUser, checkAuth, isCheckingAuth, getFriends, getFriendRequests } =
    useAuthStore();
  ...
  return (
    <div
      data-theme={theme}
      className="bg-token-base-100 w-full h-screen text-[var(--token-text-primary)]"
    >
      <Toaster />
